        ...
        <form className="px-4">
          ...
          <div className="mb-5">
            <input
              ...
              className=" w-full rounded-md border-[#e0e0e0]
              bg-white py-3 px-6 text-base font-medium text-[#687289]
          ...
          <div>
            <button className="hover:shadow-md rounded-md bg-[#6a64f1] hover:bg-orange-600 py-3 px-8 text-base font-semibold text-white outlin-none">
              Login
            </button>
          </div>
        </form>
